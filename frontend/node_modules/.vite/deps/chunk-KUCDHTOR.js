...
function zoom_default2() {
  ...
  function mousedowned(event, ...args) {
    ...
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v = select_default4(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default2(event, currentTarget), x0 = event.clientX, y0 = event.clientY;
    nodrag_default(event.view);
  ...
  function dblclicked(event, ...args) {
    if (!filter3.apply(this, arguments)) return;
    var t02 = this.__zoom, p0 = pointer_default2(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t02.invert(p0), k1 = t02.k * (event.shiftKey ? 0.5 : 2), t12 = constrain(translate(scale(t02, k1), p0, p1), extent.apply(this, args), translateExtent);
    noevent_default2(event);
    if (duration > 0) select_default4(this).transition().duration(duration).call(schedule, t12, p0, event);
    else select_default4(this).call(zoom.transform, t12, p0, event);
  }
...
//# sourceMappingURL=chunk-KUCDHTOR.js.map
