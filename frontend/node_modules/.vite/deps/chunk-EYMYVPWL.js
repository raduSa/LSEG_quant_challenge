...
// node_modules/mdast-util-from-markdown/node_modules/micromark-util-character/dev/lib/unicode-punctuation-regex.js
...
function classifyCharacter(code) {
  if (code === codes.eof || markdownLineEndingOrSpace2(code) || unicodeWhitespace3(code)) {
...
function tokenizeAutolink(effects, ok2, nok) {
  ...
  function schemeOrEmailAtext(code) {
    if (code === codes.plusSign || code === codes.dash || code === codes.dot || asciiAlphanumeric2(code)) {
      size = 1;
  ...
  function schemeInsideOrEmailAtext(code) {
    ...
    if ((code === codes.plusSign || code === codes.dash || code === codes.dot || asciiAlphanumeric2(code)) && size++ < constants.autolinkSchemeSizeMax) {
      effects.consume(code);
  ...
  function emailAtSignOrDot(code) {
    return asciiAlphanumeric2(code) ? emailLabel(code) : nok(code);
  }
  ...
  function emailValue(code) {
    if ((code === codes.dash || asciiAlphanumeric2(code)) && size++ < constants.autolinkDomainSizeMax) {
...
function factoryDestination(effects, ok2, nok, type, literalType, literalMarkerType, rawType, stringType, max) {
  ...
  function start(code) {
    ...
    if (code === codes.eof || code === codes.space || code === codes.rightParenthesis || asciiControl2(code)) {
      return nok(code);
    }
    effects.enter(type);
  ...
  function enclosed(code) {
    ...
    if (code === codes.eof || code === codes.lessThan || markdownLineEnding2(code)) {
      return nok(code);
    }
    effects.consume(code);
  ...
  function raw(code) {
    if (!balance && (code === codes.eof || code === codes.rightParenthesis || markdownLineEndingOrSpace3(code))) {
      effects.exit(types.chunkString);
      effects.exit(stringType);
    ...
    if (code === codes.eof || code === codes.space || code === codes.leftParenthesis || asciiControl2(code)) {
      return nok(code);
    }
    effects.consume(code);
...
function factoryLabel(effects, ok2, nok, type, markerType, stringType) {
  ...
  function labelInside(code) {
    if (code === codes.eof || code === codes.leftSquareBracket || code === codes.rightSquareBracket || markdownLineEnding3(code) || size++ > constants.linkReferenceSizeMax) {
      effects.exit(types.chunkString);
      return atBreak(code);
    }
    effects.consume(code);
...
function factoryTitle(effects, ok2, nok, type, markerType, stringType) {
  ...
  function inside(code) {
    if (code === marker || code === codes.eof || markdownLineEnding4(code)) {
      effects.exit(types.chunkString);
      return atBreak(code);
    }
    effects.consume(code);
...
function tokenizeHtmlFlow(effects, ok2, nok) {
  ...
  function tagName(code) {
    ...
    if (code === codes.dash || asciiAlphanumeric2(code)) {
      effects.consume(code);
      buffer += String.fromCharCode(code);
      return tagName;
    }
  ...
  function completeAttributeNameBefore(code) {
    ...
    if (code === codes.colon || code === codes.underscore || asciiAlpha2(code)) {
      effects.consume(code);
  ...
  function completeAttributeName(code) {
    if (code === codes.dash || code === codes.dot || code === codes.colon || code === codes.underscore || asciiAlphanumeric2(code)) {
      effects.consume(code);
      return completeAttributeName;
    }
  ...
  function completeAttributeValueQuotedAfter(code) {
    if (code === codes.slash || code === codes.greaterThan || markdownSpace2(code)) {
      return completeAttributeNameBefore(code);
    }
    return nok(code);
  }
  ...
  function continuationRawEndTag(code) {
    ...
    if (asciiAlpha2(code) && buffer.length < constants.htmlRawSizeMax) {
      effects.consume(code);
      buffer += String.fromCharCode(code);
      return continuationRawEndTag;
    }
...
function tokenizeListStart(effects, ok2, nok) {
  ...
  function start(code) {
    ...
    if (kind === types.listUnordered ? !self.containerState.marker || code === self.containerState.marker : asciiDigit2(code)) {
  ...
  function inside(code) {
    ok(self.containerState, "expected state");
    if (asciiDigit2(code) && ++size < constants.listItemValueSizeMax) {
      effects.consume(code);
      return inside;
    }
...
//# sourceMappingURL=chunk-EYMYVPWL.js.map
